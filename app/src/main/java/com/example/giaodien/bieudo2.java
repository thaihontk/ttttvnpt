...
public class bieudo2 extends Activity implements GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    for(int i=0;i<11;i++){
                        yValues.add(new PieEntry(brcd[i],donvi[i]));
                    }

                    Description description = new Description();
                    description.setText("BRCD");
